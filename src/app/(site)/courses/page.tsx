...
export const metadata: Metadata = {
  title: 'Courses',
  description:
    'Every programme offered by MGIMST across engineering, management, computer applications, science, commerce and arts — at diploma, bachelor, PG diploma and masters level.',
};
