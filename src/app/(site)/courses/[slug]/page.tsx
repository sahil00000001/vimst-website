              ...
              <div className="sticky top-28 space-y-6">
                ...
                <Reveal from="left" delay={0.08}>
                  <div className="rounded-2xl border border-rule bg-paper p-6">
                    ...
                    <Link
                      href="/fee-structure"
                      className="group mt-6 inline-flex items-center gap-2 text-[length:var(--text-sm)] font-medium text-ink transition-colors hover:text-crimson"
                    >
                      See fee structure
