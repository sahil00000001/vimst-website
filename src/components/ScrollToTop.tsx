    ...
    <AnimatePresence>
      {show && (
        <motion.button
          ...
          className="fixed bottom-5 right-4 z-40 flex h-11 w-11 items-center justify-center rounded-full border border-rule bg-paper/95 text-ink shadow-[0_10px_30px_-12px_rgba(22,21,26,0.35)] backdrop-blur transition-colors hover:border-crimson hover:text-crimson sm:bottom-8 sm:right-8 sm:h-12 sm:w-12"
        >
